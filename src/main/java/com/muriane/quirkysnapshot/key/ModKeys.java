...
public class ModKeys {
    public static KeyMapping.Category IFIM_KEY_CATEGORY = new KeyMapping.Category(Identifier.fromNamespaceAndPath(QuirkySnapshot.MOD_ID, "fast_screenshot"));

    public static KeyMapping FAST_SCREENSHOT = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.fast_screenshot",
    ...
    public static KeyMapping SELECTION = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.selection",
    ...
    public static KeyMapping BRUSH = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.brush",
            KeyConflictContext.GUI,
            InputConstants.Type.KEYSYM,
    ...
    public static KeyMapping CUT = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.cut",
            KeyConflictContext.GUI,
            InputConstants.Type.KEYSYM,
    ...
    public static KeyMapping COLOR_PALETTE = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.color_palette",
            KeyConflictContext.GUI,
            InputConstants.Type.KEYSYM,
    ...
    public static KeyMapping BRUSH_SIZE = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.brush_size",
            KeyConflictContext.GUI,
            InputConstants.Type.KEYSYM,
    ...
    public static KeyMapping UNDO_REDO = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.undo_redo",
            KeyConflictContext.GUI,
            InputConstants.Type.KEYSYM,
    ...
    public static KeyMapping SAVE = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.save",
            KeyConflictContext.GUI,
            InputConstants.Type.KEYSYM,
    ...
    public static KeyMapping SHARE = new KeyMapping(
            "key.quirkysnapshot.fast_screenshot.share",
            KeyConflictContext.GUI,
            InputConstants.Type.KEYSYM,
